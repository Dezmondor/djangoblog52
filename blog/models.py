...
class Post(models.Model):
    ...
    auther = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name="Автор", default=1)
...
class Profile(models.Model):
    ...
    def __str__(self):
        return f"Profile {self.settings.AUTH_USER_MODEL.username}"
